...
namespace XSDCustomToolVSIX
{
    ...
    /// </summary>
    class GenerateHelperClass_JavaScript : GenerateHelperClass_Base
    {

        public GenerateHelperClass_JavaScript(XSD_Instance xsdSettings) : base(xsdSettings)
        { throw new NotImplementedException("JavaScript Output Helper Not Implemented!"); }

        public override string OutputClassName => base.OutputClassName;

        protected override string CommentIndicator => "#";

        public override FileInfo FileOnDisk => new FileInfo(base.xSD_Instance.InputFile.FullName.Replace(".xsd", "_HelperClass.js"));
    ...
    class SourceClass_JavaScript : SourceClass
    {
        /// <inheritdoc cref="SourceClass.SourceClass(string)"/>
        public SourceClass_JavaScript(string className, string[] classText) : base(className, classText) { }

        /// <inheritdoc cref="SourceClass.SourceClass(string, bool)"/>
        public SourceClass_JavaScript(string className, string[] classText, bool isTopLevelNode) : base(className, classText, isTopLevelNode) { }
