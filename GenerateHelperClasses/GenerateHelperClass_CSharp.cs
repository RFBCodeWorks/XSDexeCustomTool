...
namespace XSDCustomToolVSIX
{
    class GenerateHelperClass_CSharp : GenerateHelperClass_Base
    {
        ...
        public override void Generate()
        {
            ...
            txt += base.GenerateAutogenComment();
        ...
        protected override string GetClassLoaderMethod(int BaseIndentLevel)
        {
            ...
            string Comments = String.Concat(
                $"{VSTools.TabIndent(BaseIndentLevel)}/// <summary>\n",
                $"{VSTools.TabIndent(BaseIndentLevel)}/// Load a file path and produce a Deserialized <typeparamref name=\"{TopLevelClass.ClassName}\"/> Object\n",
                $"{VSTools.TabIndent(BaseIndentLevel)}/// </summary>\n",
                $"{VSTools.TabIndent(BaseIndentLevel)}/// <param name=\"FilePath\"> This XML file to read into the class object </param>\n",
                $"{VSTools.TabIndent(BaseIndentLevel)}/// <returns> A new <typeparamref name=\"{TopLevelClass.ClassName}\"/> object </returns>\n"
                );
        ...
        protected override string GetClassSaverMethod(int BaseIndentLevel)
        {
            string Comments = String.Concat(
                $"{VSTools.TabIndent(BaseIndentLevel)}/// <summary>\n",
                $"{VSTools.TabIndent(BaseIndentLevel)}/// This method will take the {TopLevelClass.ClassName} object, create an XML serializer for it, and write the XML to the <paramref name = \"FilePath\" />\n",
                $"{VSTools.TabIndent(BaseIndentLevel)}/// </summary>\n",
                $"{VSTools.TabIndent(BaseIndentLevel)}/// <param name=\"FilePath\"> Destination file path to save the file into. </param>\n"
                );
