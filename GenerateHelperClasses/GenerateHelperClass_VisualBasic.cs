...
{
    /// <summary>
    /// This class is framed in, but not implemented as I only needed implementation for C# at time of writing.
    /// </summary>
    class GenerateHelperClass_VB : GenerateHelperClass_Base
    {

        public GenerateHelperClass_VB(XSD_Instance xsdSettings) : base(xsdSettings)
        { throw new NotImplementedException("Visual Basic Output Helper Not Implemented!"); }

        public override string OutputClassName => base.OutputClassName;

        protected override string CommentIndicator => "''";

        public override FileInfo FileOnDisk => new FileInfo(base.xSD_Instance.InputFile.FullName.Replace(".xsd", "_HelperClass.vb"));
    ...
    class SourceClass_VB : SourceClass
    {
        /// <inheritdoc cref="SourceClass.SourceClass(string)"/>
        public SourceClass_VB(string className, string[] classText) : base(className, classText) { }

        /// <inheritdoc cref="SourceClass.SourceClass(string, bool)"/>
        public SourceClass_VB(string className, string[] classText, bool isTopLevelNode) : base(className, classText, isTopLevelNode) { }
