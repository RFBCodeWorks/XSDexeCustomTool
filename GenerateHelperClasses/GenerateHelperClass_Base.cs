...
namespace XSDCustomToolVSIX
{
    ...
    abstract class GenerateHelperClass_Base : IHelperClass
    {
        ...
        protected virtual string GenerateAutogenComment() {
            string FileText = "";
        ...
        /// </summary>
        protected virtual void ReadInClassFile()
        {
        ...
        /// </summary>
        protected virtual void AddToProject()
        {
            if (this.FileOnDisk.Exists)
                VSTools.AddFileToProject(xSD_Instance.InputFile, this.FileOnDisk);
        }
